...
//
// d_draw32.s
// x86 assembly-language horizontal 8-bpp span-drawing code, with 32-pixel
// subdivision.  hacked up by leilei
//
...
LClampReentry5:
	...
	imull	reciprocal_table_32-16(,%ecx,4)	// sstep = (snext - s) /
											//  (spancount-1)
	movl	%edx,%ebp

	movl	%ebx,%eax
	imull	reciprocal_table_32-16(,%ecx,4)	// tstep = (tnext - t) /
											//  (spancount-1)
LSetEntryvec:
//
// set up advancetable
//
	movl	entryvec_table_32(,%ecx,4),%ebx
	movl	%edx,%eax
...
LNoSteps:
	movb	(%esi),%al		// load first texel in segment
	subl	$31,%edi			// adjust for hardwired offset
	jmp		LEndSpan
...
.globl	Entry2_32, Entry3_32, Entry4_32, Entry5_32
.globl	Entry6_32, Entry7_32, Entry8_32, Entry9_32
.globl	Entry10_32, Entry11_32, Entry12_32, Entry13_32
.globl	Entry14_32, Entry15_32, Entry16_32, Entry17_32
.globl	Entry18_32, Entry19_32, Entry20_32, Entry21_32
.globl	Entry22_32, Entry23_32, Entry24_32, Entry25_32
.globl	Entry26_32, Entry27_32, Entry28_32, Entry29_32
.globl	Entry30_32, Entry31_32, Entry32_32


Entry2_32:
	subl	$30,%edi		// adjust for hardwired offsets
	movb	(%esi),%al
	jmp		LEntry2_32
...
Entry3_32:
	subl	$29,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry4_32:
	subl	$28,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry5_32:
	subl	$27,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry6_32:
	subl	$26,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry7_32:
	subl	$25,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry8_32:
	subl	$24,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry9_32:
	subl	$23,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry10_32:
	subl	$22,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry11_32:
	subl	$21,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry12_32:
	subl	$20,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry13_32:
	subl	$19,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry14_32:
	subl	$18,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry15_32:
	subl	$17,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry16_32:
	subl	$16,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
...
Entry30_32:
	subl	$1,%edi		// adjust for hardwired offsets
	addl	%eax,%edx
	movb	(%esi),%al
	sbbl	%ecx,%ecx
	addl	%ebp,%ebx
