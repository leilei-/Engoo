...
//LONG CDAudio_MessageHandler(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);	// 2001-12-10 Reduced compiler warnings by Jeff Ford
	...
	LPARAM	lParam)
{
	...
	HDC				hdc;
	PAINTSTRUCT		ps;
//	static int		recursiveflag;	// 2001-12-10 Reduced compiler warnings by Jeff Ford
