...
LClampReentry5:
	...
	imull	reciprocal_table_64-8(,%ecx,4)	// sstep = (snext - s) /
											//  (spancount-1)
	movl	%edx,%ebp

	movl	%ebx,%eax
	imull	reciprocal_table_64-8(,%ecx,4)	// tstep = (tnext - t) /
											//  (spancount-1)
LSetEntryvec:
//
// set up advancetable
//
	movl	entryvec_table_64(,%ecx,4),%ebx
	movl	%edx,%eax
...
.globl	Entry2_64, Entry3_64, Entry4_64, Entry5_64
.globl	Entry6_64, Entry7_64, Entry8_64, Entry9_64
.globl	Entry10_64, Entry11_64, Entry12_64, Entry13_64
.globl	Entry14_64, Entry15_64, Entry16_64
